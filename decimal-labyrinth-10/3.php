  ...
  <style>
    * { 
    ...
    .face {
      ...
      color: #fff;
      transition: color 900ms, transform 400ms, background-image 4000ms;
...
<script>
  ...
  document.addEventListener('keydown', function (e) {
    ...
    if (e.key === "x") { changeBg("bg-kybalion.png"); }
    if (e.key === "c") { changeBg("high1.png"); }
    if (e.key === "v") { changeBg("high2.png"); }
  }
);
