        ...
        <div class="container-fluid">
          <div class="row">
            <div class="col-12">
              ...
              <div class="font-s">
                <a onclick="scrollToInfo();" class="font-soft font-white pointer no-u">INFO</a>
                &nbsp;&nbsp;&nbsp;
                <a onclick="closeHome();" class="font-soft font-white pointer no-u">ENTER THE EXHIBITION</a>
                &nbsp;&nbsp;&nbsp;
                <a onclick="handleAudioClick();" class="font-soft font-white pointer no-u">AUDIO</a>
              </div>
            </div>
          </div>
        </div>
...
function locationHashChanged () {
  ...
  if (location.hash.substr(0, 2) === "#/") {
    ...
    if (soundtrack.readyState) { soundtrack.pause(); }
...
if (soundtrack.canPlayType('audio/mpeg')) {
  soundtrack.setAttribute('src','sound/marco-1.mp3');
