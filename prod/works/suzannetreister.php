    ...
    <div class="container-fluid">
      <div class="row">
        ...
        <div class="col-md-3 text-center">
          ...
          <div class="px-lg-4 my-5"><a target="suzanne" href="http://www.suzannetreister.net/TechnoShamanicSystems/TSS/TSS_Apparel.html">
            <img class="img-fluid" src="works/suzannetreister/img/col-a-1.gif" /></a></div>
          <div class="px-lg-4 my-5"><a target="suzanne" href="http://www.suzannetreister.net/TechnoShamanicSystems/TSS/TSS_Rituals.html">
            <img class="img-fluid" src="works/suzannetreister/img/col-a-2.gif" /></a></div>
          <div class="px-lg-4 my-5"><a target="suzanne" href="http://www.suzannetreister.net/TechnoShamanicSystems/TSS/TSS_SocialStructures.html">
            <img class="img-fluid" src="works/suzannetreister/img/col-a-3.gif" /></a></div>
          <div class="px-lg-4 my-5"><a target="suzanne" href="http://www.suzannetreister.net/TechnoShamanicSystems/TSS/TSS_Architectures.html">
            <img class="img-fluid" src="works/suzannetreister/img/col-a-4.gif" /></a></div>
          <div class="px-lg-4 my-5"><a target="suzanne" href="http://www.suzannetreister.net/TechnoShamanicSystems/TSS/TSS_Vultures.html">
        ...
        <div class="col-md-6 text-center">
          ...
          <div class="mb-5"><a target="suzanne" href="http://www.suzannetreister.net/TechnoShamanicSystems/TSS/TSS_Diagrams.html">
            <img class="img-fluid" src="works/suzannetreister/img/col-main-1.gif" /></a></div>
          <div class="mb-5"><a target="suzanne" href="http://www.suzannetreister.net/TechnoShamanicSystems/TSS/TSS_Stars.html">
        ...
        <div class="col-md-3 text-center">
          ...
          <div class="px-lg-4 my-5"><a target="suzanne" href="http://www.suzannetreister.net/TechnoShamanicSystems/TSS/TSS_ReinTech.html">
            <img class="img-fluid" src="works/suzannetreister/img/col-b-1.gif" /></a></div>
          <div class="px-lg-4 my-5"><a target="suzanne" href="http://www.suzannetreister.net/TechnoShamanicSystems/TSS/TSS_CrystalArc.html">
            <img class="img-fluid" src="works/suzannetreister/img/col-b-2.gif" /></a></div>
          <div class="px-lg-4 my-5"><a target="suzanne" href="http://www.suzannetreister.net/TechnoShamanicSystems/TSS/TSS_SpacecraftD.html">
            <img class="img-fluid" src="works/suzannetreister/img/col-b-3.gif" /></a></div>
          <div class="px-lg-4 my-5"><a target="suzanne" href="http://www.suzannetreister.net/TechnoShamanicSystems/TSS/TSS_SpaceHab.html">
            <img class="img-fluid" src="works/suzannetreister/img/col-b-4.gif" /></a></div>
          <div class="px-lg-4 my-5"><a target="suzanne" href="http://www.suzannetreister.net/TechnoShamanicSystems/TSS/TSS_Visions.html">
