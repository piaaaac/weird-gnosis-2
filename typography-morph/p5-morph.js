...
var p5Sketch = new p5(function (p) {
  ...
  p.preload = function () {
    ...
    // var f = window.assetsFolder +"/fonts/Pitch-Sans/PitchSans-Bold.otf";
    // var f = window.assetsFolder +"/fonts/Pachinko/Pachinko-Regular-Mono.otf";
...
/*
    ...
    // --- PITCH SANS BOLD -------------------------------------------------------
    // fontSize = 200;
    // letters["tilde"] = font1.textToPoints("~", 0, 0, fontSize, {sampleFactor: 0.423});
    // letters["A"] = font1.textToPoints("A", 0, 0, fontSize, {sampleFactor: 0.181});
    // letters["B"] = font1.textToPoints("B", 0, 0, fontSize, {sampleFactor: 0.1472});
    // letters["C"] = font1.textToPoints("C", 0, 0, fontSize, {sampleFactor: 0.186});
    // letters["E"] = font1.textToPoints("E", 0, 0, fontSize, {sampleFactor: 0.149});
    // letters["I"] = font1.textToPoints("I", 0, 0, fontSize, {sampleFactor: 0.198});
    // letters["L"] = font1.textToPoints("L", 0, 0, fontSize, {sampleFactor: 0.254});
    // letters["M"] = font1.textToPoints("M", 0, 0, fontSize, {sampleFactor: 0.126});
    // letters["O"] = font1.textToPoints("O", 0, 0, fontSize, {sampleFactor: 0.168});
    // letters["P"] = font1.textToPoints("P", 0, 0, fontSize, {sampleFactor: 0.185});
    // letters["R"] = font1.textToPoints("R", 0, 0, fontSize, {sampleFactor: 0.153});
    // letters["T"] = font1.textToPoints("T", 0, 0, fontSize, {sampleFactor: 0.229});
    // letters["X"] = font1.textToPoints("X", 0, 0, fontSize, {sampleFactor: 0.17});
    // letters["Y"] = font1.textToPoints("Y", 0, 0, fontSize, {sampleFactor: 0.226});
    // letters["-"] = font1.textToPoints("·", 0, 0, fontSize, {sampleFactor: 0.810});
    // --- PITCH SANS BOLD -------------------------------------------------------
    ...
    // letters["A2"] = font2.textToPoints("A", 0, 0, fontSize, {sampleFactor: 0.2513});
    // letters["B2"] = font2.textToPoints("B", 0, 0, fontSize, {sampleFactor: 0.1952});
    // letters["C2"] = font2.textToPoints("C", 0, 0, fontSize, {sampleFactor: 0.255});
    ...
    // letters["F2"] = font2.textToPoints("F", 0, 0, fontSize, {sampleFactor: 0.290});
    letters["G2"] = font2.textToPoints("G", 0, 0, fontSize, {sampleFactor: 0.194});
    // letters["H2"] = font2.textToPoints("H", 0, 0, fontSize, {sampleFactor: 0.233});
    letters["I2"] = font2.textToPoints("I", 0, 0, fontSize, {sampleFactor: 0.339});
    // letters["J2"] = font2.textToPoints("J", 0, 0, fontSize, {sampleFactor: 0.323});
    // letters["K2"] = font2.textToPoints("K", 0, 0, fontSize, {sampleFactor: 0.240});
    // letters["L2"] = font2.textToPoints("L", 0, 0, fontSize, {sampleFactor: 0.379});
    // letters["M2"] = font2.textToPoints("M", 0, 0, fontSize, {sampleFactor: 0.169});
    ...
    // letters["P2"] = font2.textToPoints("P", 0, 0, fontSize, {sampleFactor: 0.263});
    // letters["Q2"] = font2.textToPoints("Q", 0, 0, fontSize, {sampleFactor: 0.1985});
    ...
    // letters["T2"] = font2.textToPoints("T", 0, 0, fontSize, {sampleFactor: 0.345});
    // letters["U2"] = font2.textToPoints("U", 0, 0, fontSize, {sampleFactor: 0.253});
    // letters["V2"] = font2.textToPoints("V", 0, 0, fontSize, {sampleFactor: 0.277});
    letters["W2"] = font2.textToPoints("W", 0, 0, fontSize, {sampleFactor: 0.1205});
    // letters["X2"] = font2.textToPoints("X", 0, 0, fontSize, {sampleFactor: 0.254});
    // letters["Y2"] = font2.textToPoints("Y", 0, 0, fontSize, {sampleFactor: 0.330});
    // letters["Z2"] = font2.textToPoints("Z", 0, 0, fontSize, {sampleFactor: 0.257});
    // ---------------------------------------------------------------------------
